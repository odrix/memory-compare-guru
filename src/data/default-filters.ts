...
export const getDefaultFilters = (): FilterConfig[] => [
  // New order for columns and filters
  // Columns: Capacité (GB), Prix, Marque, Technologie, Vitesse lecture, Vitesse écriture, RPM, Cache, Format, Type, Interface, Poids, Garantie, Évaluation
  // Filters: Type, Format, Capacité (GB), Prix, Marque, Vitesse lecture, Vitesse écriture, Cache, Interface, Technologie, RPM, Poids, Garantie, Évaluation
  ...
  { field: 'rpm', label: 'RPM', type: 'range', min: 5400, max: 15000, unit: 'RPM', isVisible: false },
