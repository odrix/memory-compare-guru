...
export const getDefaultFilters = (): FilterConfig[] => [
  ...
  { field: 'technology', label: 'Technologie', type: 'select', options: ['CMR', '3D NAND', '3D V-NAND', 'NVMe'], isVisible: true },
  ...
  { field: 'weight', label: 'Poids', type: 'range', min: 0, max: 1000, unit: 'g', isVisible: true },
  { field: 'warranty', label: 'Garantie', type: 'range', min: 0, max: 60, unit: 'mois', isVisible: true },
